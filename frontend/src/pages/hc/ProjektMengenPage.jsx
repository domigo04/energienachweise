...
// externe Ergänzungen (zusätzliche Wärmezähler, Rohrmeter …) und bewusste
// Übersteuerungen (§20/§21). Reine Sicht auf die eine Projektwahrheit.
...
// Herkunft klar benennen (§20): Schema / Projekt / Ergänzung / manuell.
const SOURCE_LABELS = {
  schema: "Schema",
  projekt: "Projekt",
  extern: "Ergänzung",
