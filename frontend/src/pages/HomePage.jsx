  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 min-h-[80vh]">
        ...
        {/* Right Side - Visuals (dekorativ, blockiert NICHT mehr die Clicks) */}
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center p-8 relative z-0">
          <div className="relative w-[600px] h-[400px] pointer-events-none">
            ...
            <div className="absolute right-0 top-0 transform rotate-12 origin-bottom-left">
              <div className="bg-white rounded-3xl p-6 shadow-xl w-72 pointer-events-auto">
                ...
                <button
                  type="button"
                  className="w-full bg-gray-900 text-white py-3 rounded-xl font-semibold mt-4"
                >
                  Kontaktieren
                </button>
              </div>
