...
function StatCard({ icon: Icon, label, value, tone = "slate" }) {
  ...
  return (
    <div className="card flex items-center gap-3 p-4">
      <div className={`flex size-10 shrink-0 items-center justify-center rounded-sm border bg-slate-50 ${tones[tone]}`}>
...
function MemberCard({ member, onPatch, busy }) {
  ...
  return (
    <article className="rounded-md border border-slate-300/80 bg-white p-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex size-10 shrink-0 items-center justify-center rounded-sm border border-slate-200 bg-slate-50 font-semibold text-slate-600">
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        {member.role === "admin" ? (
          <div className="rounded-sm border-l-2 border-slate-300 bg-slate-50 px-3 py-2 text-center text-xs text-slate-500">
            ...
            <div className="divide-y divide-slate-100">
              {data.aktivitaeten.map((event) => (
                <article key={event.id} className="grid gap-2 px-4 py-4 sm:grid-cols-[auto_1fr_auto] sm:items-center sm:gap-4 sm:px-5">
                  <div className="flex size-9 items-center justify-center rounded-sm border border-slate-200 bg-slate-50 text-slate-600">
