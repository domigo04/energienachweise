...
import { LogOut, PlusCircle, FolderOpen, Sparkles } from "lucide-react";
...
const response = await fetch(`${apiUrl}/customers/projects`, {
  headers: {
...
if (Array.isArray(data)) {
  ...
  setProjekte([]); // Fallback
      ...
      setProjekte([]); // Fallback: leere Liste
      setLoading(false);
    }
  };
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-6 border border-white/20">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Verwalte deine Energieprojekte zentral an einem Ort</p>
            </div>
            <button
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Noch keine Projekte</h3>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <span className="text-xs text-gray-500">
                        Erstellt: {new Date(projekt.erstellt).toLocaleDateString('de-DE')}
                      </span>
                    </div>
                  </div>
                </div>
