...
class HcProject(Base):
    ...
    bauherr = Column(String, nullable=True)
    sia_phase = Column(String, nullable=True)
    projektfortschritt_pct = Column(Integer, default=0)
    planbezeichnung = Column(String, default="Prinzipschema")
